...
- zobrazenie vizualizácií pre ilustráciu vzťahov medzi rôznymi premennými, ktoré budú použité na vhodné zostavenie modelu, nie súčasť DÚ
...
- zamietame nulovú hypotézu, že beta_i = 0 pre všetky odhadnuté parametre vo finálnom modeli lrModelFinal, pretože p-hodnota t-testov všetkých parametrov je nižšia ako 5% hladina významnosti (0.05), na ktorej boli všetky t-testy robené
...
- náhodná zložka eps pochádza z normálneho rozdelenia so strednou hodnotou 0 a rozptylom 640
- premenná IQ pochádza z normálneho rozdelenia so strednou hodnotou 90 a rozptylom 1000 
...
set.seed(1)
N <- 10000
eps <- rnorm(N, 0, sqrt(640))
IQ <- rnorm(N, 90, sqrt(1000))
...
- Interpretácia koeficientu pri premennej educ: ak vzrastie premenná educ o 1 (1 rok vzdelania naviac), tak v priemere môžeme očakávať, že wage sa zvýši o 4.871930 peňažných jednotiek
- Interpretácia koeficientu pri premennej exper: ak sa zvýši premenná exper o 1 (1 rok praktickej skúsenosti naviac), tak v priemere môžeme očakávať, že wage sa zvýši o 6.036123 peňažných jednotiek
...
- R_squared = 0.994 - modelom sa podarilo vysvetliť 99.4% variability vysvetlovanej premennej
